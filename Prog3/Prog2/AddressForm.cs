...
namespace Prog2
{
    public partial class AddressForm : Form
    {
        ...
        public AddressForm()
        {
            ...
            stateCbo.Text = DEFAULT_STATE;
        }

        internal string AddressName
        {
            // Precondition:    None
            // Postcondition:   The text of the form's field is returned
            get
            {
                return nameTxt.Text;
            }
        ...
        {
            // Precondition:    None
            // Postcondition:   The text of form's Address1 Feild is returned
            get
            {
        ...
        {
            // Precondition:    None
            // Postcondition:   The text of form's Address 2 field is returned
            get
            {
        ...
        private void zipTxt_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (!int.TryParse(zipTxt.Text, out zip)
                || (zip < Address.MIN_ZIP) || (zip > Address.MAX_ZIP)) // Invalid so
            {
                e.Cancel = true;
                zipTxt.SelectAll();
        ...
        //               sender is TextBox
        // Postcondition: if text is invalid, focus remains and error
        //              highlights the field

        private void RequiredTextFields_Validating(object sender, CancelEventArgs e)
        {
            // Downcast to sender as TextBox, so make sure you okey precondition!
            ...
            if (string.IsNullOrWhiteSpace(textbox.Text)) // Empty field
            {
                ...
                // error provider.seterror(textbox, "must enter a value!");

                // ---OR---

                // Alternative error message with specific field named
        ...
        private void cancelBtn_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            // Click won't be allowed if other fields validation fails
